...
TELEGRAM_TOKEN = os.getenv("ORDER_BOT_TOKEN")
...
class Config:
    ...
    def validate(cls) -> None:
        if not cls.TELEGRAM_TOKEN or not cls.OPENAI_API_KEY or not CREDS_JSON or not CUSTOMERS_JSON:
...
class OrderBot:
    ...
    async def _load_customers(self) -> None:
        try:
            ...
            raise ValueError(f"Failed to load customers: {e}")
